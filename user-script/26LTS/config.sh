...
# gnome terminal
TERMINAL_PROFILE_ID=$(gsettings get org.gnome.Ptyxis default-profile-uuid | tr -d "[]'")
gsettings set org.gnome.Ptyxis.Profile:/org/gnome/Ptyxis/Profiles/$TERMINAL_PROFILE_ID/ palette gnome
gsettings set org.gnome.Ptyxis.Profile:/org/gnome/Ptyxis/Profiles/$TERMINAL_PROFILE_ID/ opacity 0.8
